...
class Pencari extends CI_Controller
{
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/templates-user/templates-login/header', $data);
            $this->load->view('autentifikasi/loginpencari');
            $this->load->view('templates/templates-user/templates-login/footer');
        } else {
            $this->_login();
        }
    }
    ...
    public function registrasi()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/templates-user/templates-login/header', $data);
            $this->load->view('autentifikasi/daftarpencari');
            $this->load->view('templates/templates-user/templates-login/footer');
        } else {
