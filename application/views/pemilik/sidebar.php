<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?= base_url('pemilik/pemilik') . $kos['user_id'] ?>">
                    <i class="align-middle" data-feather="home"></i> <span class="align-middle">Data Kost</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?= base_url('pemilik/tambahKos') ?>">
                    <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Tambah Kost</span>
                </a>
            </li>
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?= base_url('pemilik/fasilitas') ?>">
